...
namespace ChatApp
{
    public partial class chat : System.Web.UI.Page
    {
        ...
        int checkNewMessage()
        {
            ...
            string StrCmd = "Select COUNT(*) from  MsgTable2 where RecevierSeen = 0 and MsgReceiver = @receiver";
        ...
        void LoadChatList()
        {
            ...
            string StrCmd = "select Msgsender,chatmsg from msgtable2 where (MsgSender = @sender and msgReceiver = @receiver) or (MsgSender = @ViseSender and msgReceiver = @ViseReceiver) order by Id";
            SqlCommand sqlcmd = new SqlCommand(StrCmd, sqlconn);
        ...
        void seenAllMsg()
        {
            ...
            string StrCmd = "update MsgTable2 set RecevierSeen = 1 where MsgReceiver = @MsgRec and MsgSender = @MsgSen";
            SqlCommand sqlcmd = new SqlCommand(StrCmd, sqlconn);
        ...
        protected void sendBTN_Click(object sender, EventArgs e)
        {
            ...
            string StrCmd = "AddMsgToTable2 @msg , @SenderName, @ReciverName";
            SqlCommand sqlcmd = new SqlCommand(StrCmd, sqlconn);
        ...
        {
            string OnlineStatusStr = "update users2 set OnlineStatus = 0 where Username = @user";
